module Fixture
  def self.getthumbinfo_sm2003
    <<-EOS
      <nicovideo_thumb_response status="ok">
        <thumb>
        <video_id>sm2003</video_id>
        <title>varfoo動画</title>
        <description>
        </description>
        <thumbnail_url>http://tn-skr3.smilevideo.jp/smile?i=2003</thumbnail_url>
        ...
        <watch_url>http://www.nicovideo.jp/watch/sm2003</watch_url>
