module Fixture
  def self.getthumbinfo_sm1002
    <<-EOS
      <nicovideo_thumb_response status="ok">
        <thumb>
        <video_id>sm1002</video_id>
        <title>動画 第2話</title>
        <description>
        </description>
        <thumbnail_url>http://tn-skr3.smilevideo.jp/smile?i=1002</thumbnail_url>
        ...
        <watch_url>http://www.nicovideo.jp/watch/sm1002</watch_url>
