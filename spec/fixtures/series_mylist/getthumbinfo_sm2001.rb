module Fixture
  def self.getthumbinfo_sm2001
    <<-EOS
      <nicovideo_thumb_response status="ok">
        <thumb>
        <video_id>sm2001</video_id>
        <title>動画abc</title>
        <description>
        </description>
        <thumbnail_url>http://tn-skr3.smilevideo.jp/smile?i=2001</thumbnail_url>
        ...
        <watch_url>http://www.nicovideo.jp/watch/sm2001</watch_url>
