module Fixture
  def self.getthumbinfo_sm1003
    <<-EOS
      <nicovideo_thumb_response status="ok">
        <thumb>
        <video_id>sm1003</video_id>
        <title>動画 第3話</title>
        <description>
        </description>
        <thumbnail_url>http://tn-skr3.smilevideo.jp/smile?i=1003</thumbnail_url>
        ...
        <watch_url>http://www.nicovideo.jp/watch/sm1003</watch_url>
