module Fixture
  def self.getthumbinfo_sm2002
    <<-EOS
      <nicovideo_thumb_response status="ok">
        <thumb>
        <video_id>sm2002</video_id>
        <title>hoge動画fuga</title>
        <description>
        </description>
        <thumbnail_url>http://tn-skr3.smilevideo.jp/smile?i=2002</thumbnail_url>
        ...
        <watch_url>http://www.nicovideo.jp/watch/sm2002</watch_url>
